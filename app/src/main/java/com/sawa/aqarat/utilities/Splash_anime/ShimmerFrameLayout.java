...
/**
 * Created by Issak.Nabil on 12/25/2017.
 */
    ...
    public ShimmerFrameLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            try {
                ...
                if (a.hasValue(R.styleable.ShimmerFrameLayout_shape_shimmer)) {
                    int shape = a.getInt(R.styleable.ShimmerFrameLayout_shape_shimmer, 0);
                    switch (shape) {
                        default:
                        case 0:
