...
package com.sawa.aqarat.utilities.Splash_anime;
...
import com.sawa.aqarat.utilities.Splash_anime.util.ImageUtils;
...
public class Splash {
    ...
    private void initViews() {
        mIvSplash =  mSplashContainer.findViewById(R.id.iv_splash_image);
        mSplashImageBackground = mSplashContainer.findViewById(R.id.splash_image_background);

        mSplashImageBackground.setBackgroundColor(ContextCompat.getColor(mContext, R.color.cardview_light_background));
        mSplashBackgroundColor = ContextCompat.getColor(mContext, R.color.cardview_light_background);
        mSplashImage = ContextCompat.getDrawable(mContext, R.drawable.ic_launcher_background);
