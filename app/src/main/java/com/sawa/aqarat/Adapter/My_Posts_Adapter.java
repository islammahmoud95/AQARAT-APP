...
public class My_Posts_Adapter extends RecyclerView.Adapter<My_Posts_Adapter.RecyclerViewHolder> {

    private Activity context;

    private ArrayList<My_Posts_Items> productsArrayList;


    SweetAlertDialog dialog_bar;
    SessionManager sessionManager;

    public My_Posts_Adapter(Activity context, ArrayList<My_Posts_Items> productsArrayList) {
    ...
    public RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_my_posts, parent, false);
    ...
    public void onBindViewHolder(final RecyclerViewHolder holder, final int position) {
        ...
        String post_status_str = productsArrayList.get(position).getPost_Status();
        if (post_status_str.equals("0")){


            holder.deactivate_btn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ...
                    if (Check_Con.getInstance(context).isOnline()) {
                        ...
                        deactivation_btn(product_id , holder.getAdapterPosition());
            ...
            Drawable roundDrawable = context.getResources().getDrawable(R.drawable.button_purple);
            roundDrawable.setColorFilter(ContextCompat.getColor(context ,R.color.red_btn_bg_pressed_color), PorterDuff.Mode.SRC_ATOP);
            holder.deactivate_btn.setBackground(roundDrawable);

            holder.deactivate_btn.setOnClickListener(null);
            holder.deactivate_btn.setText(R.string.closed_str);
    ...
    static class RecyclerViewHolder extends RecyclerView.ViewHolder {
        ...
        Context context;
        ArrayList<My_Posts_Items> productsArrayList;


        RecyclerViewHolder(View view, Context context, final ArrayList<My_Posts_Items> productsArrayList) {
            ...
            deactivate_btn = view.findViewById(R.id.deactivate_btn);
    ...
    private void deactivation_btn(final String post_id , final int position) {

        StringRequest stringRequest = new StringRequest(Request.Method.POST, Utility.URL + "users/stopPost",
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (status) {
                                ...
                                dialog_bar.setContentText("This Post Successfully Deactivated");
                                dialog_bar.setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                    ...
                                    public void onClick(SweetAlertDialog sweetAlertDialog) {
                                        ...
                                        productsArrayList.get(position).setPost_Status("1");
                                        notifyItemChanged(position);
                                     //   notifyItemRangeChanged(position , productsArrayList.size()-1);
